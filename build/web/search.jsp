...
<!--                        <div class="banner col-lg-12 col-md-12 col-sm-12">
        ...
        <script>
            ...
            params.set('search', '${requestScope.search}');
            params.set('brand', '${requestScope.brand}');
            params.set('priceFrom', ${requestScope.priceFrom});
            params.set('priceTo', ${requestScope.priceTo});
        ...
        for (let i = 0; i < pagger.length; i++) {
            ...
            paggerBasic('pagination',${requestScope.pageIndex}, ${requestScope.totalPages}, 1);
                </script>
